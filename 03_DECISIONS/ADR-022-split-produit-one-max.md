...
- **Date** : 2026-06-16
- **Phase** : 1
- **Faisabilité** : 🟠 Moyenne (données Arko One incomplètes)
...
- **Deux produits** dans un registre `PRODUCTS` (`src/lib/site.ts`) :
  - **Arko One** — 20 m², **12 exemplaires**, base **59 900 €**. Grille propre (perM2, options, terrasse, dimensions) **à fournir** : valeurs provisoires `TODO ARKO ONE`.
  - **Arko Max** — 40 m² (= ARKO historique), **5 exemplaires** (était 12), 89 900 €, grille inchangée.
...
- **Dépendances externes** : valeurs Arko One (prix/dimensions), asset vidéo Arko One, confirmation Albert.
...
- Données à confirmer avant mise en vente : grille One, total Max = 5, `reserved` par produit, asset One.
